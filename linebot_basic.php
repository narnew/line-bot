...
$channelAccessToken = 'KiwDFhY6im6LoTnTbDz0H/jiSb9KQBZqK/YXOto8HoEMo4/kZI0JQEe10dBi4LRwbrwClO7YyXt/XybRI83oKaqZXxZkF+liuucK0NXTjKRipaRC6Mv5vPKks6YPd17HD+L0C1/XSl+xz8lU3iMtbgdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
...
foreach ($request_json['events'] as $event)
{
	if ($event['type'] == 'message') 
	{
		if($event['message']['type'] == 'text')
		{
			...
			$reply_message = "narnew";
			
			$reply_message = mySQL_selectAll('http://s61160063.kantit.com/json_select.php');
